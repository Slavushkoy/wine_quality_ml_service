...
def main():
    ...
    if page == "Регистрация и вход":
        st.title('Приветсвтвую, юный падаван!')
        st.text('Здесь ты можешь узнать больше о вине.\n'
                'Зная химические параметры вина, предсказать его оценку по 10 бальной системе.\n'
                'Стоимость одного предсказания 100 кредитов.\n'
                'После регистрации тебе будет доступно 300 кредитов.\n'
                'Ты сможешь убдеться в точности предсказаний и больше никогда не купишь плохое вино!')
